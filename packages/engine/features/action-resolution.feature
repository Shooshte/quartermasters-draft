Feature: Item activation action resolution
  ...
  Scenario: Later effects stay within the surviving original target group
    ...
    When "Warrior" acts
    Then "Beta Follow-up" applies only to "Knight"
    And "Warrior" does not retarget another unit
