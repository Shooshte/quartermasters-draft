...
function SortIndicator({ active, dir }: { active: boolean; dir: UnitSortDir }) {
...
export function UnitLibraryList({
  items,
  isLoading,
  isFetching,
  selectedId,
    ...
    return (
      <div className={`flex flex-col items-center justify-center gap-2 p-4`}>
        <div data-testid="empty-list">
          <p className="text-sm text-muted-foreground">No unit records yet</p>
        </div>
